...
logDirect:{[id;zcmd;endw;endz;result;arg;startz;startw] / log complete action
	if[LEVEL>1;H enlist(`LOADUSAGE;`USAGE;(id;startz;endz;startw;endw;zcmd;.z.a;.z.u;.z.w;.dotz.txtC[zcmd;arg];1b;`;enlist arg))];result}
logBefore:{[id;zcmd;arg;startz] / log non-time/space info before execution
	if[LEVEL>1;H enlist(`LOADUSAGEBEFORE;`USAGE;(id;startz;0Nz;0j;0j;zcmd;.z.a;.z.u;.z.w;.dotz.txtC[zcmd;arg];0b;`;enlist arg))];}
logAfter:{[id;endw;endz;result;startz;startw] / fill in time/space info after execution 
	if[LEVEL>1;H enlist(`LOADUSAGEAFTER;`USAGE;(id;1b;startz;endz;startw;endw))];result}
logError:{[id;endz;error] / fill in error info
	if[LEVEL>0;H enlist(`LOADUSAGEERROR;`USAGE;(id;0b;endz;`$error))];'error}
...
/.z.pw:{logDirect[.usage.nextid[];`pw;0j;.z.z;x[y;z];(y;"***");.z.z;0j]}.z.pw
.z.pw:p0[`pw;.z.pw;;]
