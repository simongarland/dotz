...
po:{[result;arg]
	...
	if[INTRUSIVE;
		(neg arg)"(neg .z.w)\"update k:\",(string .z.k),\",K:\",(string .z.K),\",c:\",(string .z.c),\",s:\",(string system\"s\"),\",o:\",(-3!.z.o),\",f:\",(-3!.z.f),\",pid:\",(string .z.i),\",pop:\",(string system\"p\"),\" from`CLIENTS where w=.z.w\""];
	result}   
