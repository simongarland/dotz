...
MAXSIZE:500000000j / 50MB max - and anyway there's a hard limit of 2G (2.X)
...
validsize:{$[MAXSIZE>-22!x;x;'`toobig]}
...
complain:{'"invalid token(s):",raze" ",'string distinct(cmdtokens cmdpt x)except usertokens .z.u}
...
.z.pg:{$[.access.vpg[y];x y;.access.complain y]}.z.pg
