...
.z.pw:  {.usage.track[`pw;0j         ;.z.z;x[y;z]                           ;(y;"***");.z.z;0j]}         .z.pw
.z.po:  {.usage.track[`po;0j         ;.z.z;x y                              ;y        ;.z.z;0j]}         .z.po
.z.pc:  {.usage.track[`pc;0j         ;.z.z;x y                              ;y        ;.z.z;0j]}         .z.pc
...
.z.exit:{.usage.track[`exit;0j       ;.z.z;x y                              ;y        ;.z.z;0j]}         .z.exit
