...
USAGE:([]startz:`datetime$();endz:`datetime$();startw:`long$();endw:`long$();zcmd:`symbol$();a:`int$();u:`symbol$();w:`int$();cmd:();ok:`boolean$();error:`symbol$())
LOADUSAGE:insert
tmp:-11!.usage.FILE
ip:{`$"."sv string"i"$0x0 vs x}
USAGE:`startz xasc update cmd:`$cmd,date:startz.date,time:startz.time,ms:86400000*endz-startz,mdelta:floor .001*endw-startw,ipa:.Q.fu[ip']a,host:.Q.fu[.Q.host']a from USAGE
USAGE:update `s#date from USAGE
if[1=count distinct exec date from USAGE;USAGE:update `s#time from USAGE]
USAGE:select date,time,ms,mdelta,zcmd,ipa,host,u,w,cmd,ok,error from USAGE
