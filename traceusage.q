...
trace:{[zcmd;endz;result;arg;startz] / record
	if[LEVEL>1;-1 blueif[ms>.usage.EXPENSIVE](" ",(string`date$startz)," ",(string`time$startz)," ms:",(string ms:86400000*endz-startz)," ",(string zcmd)," a:",(string .dotz.ipa .z.a)," u:",(string .z.u)," w:",(string .z.w)," | ",.dotz.txtc[zcmd;arg])];
	result}
