...
USAGE:`startz xasc update cmd:`$cmd,date:startz.date,time:startz.time,ms:86400000*endz-startz,ipa:.Q.fu[ip']a from USAGE
USAGE:update `s#date from USAGE
if[1=count distinct exec date from USAGE;USAGE:update `s#time from USAGE]
USAGE:select date,time,ms,zcmd,ipa,u,w,cmd,ok,error from USAGE
